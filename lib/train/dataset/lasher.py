...
class LasHeR(BaseVideoDataset):
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        rgb_frame_path = os.path.join(seq_path, 'visible', '{:05d}v.png'.format(frame_id))  # frames start from 0
        ir_frame_path = os.path.join(seq_path, 'infrared', '{:05d}i.png'.format(frame_id))
