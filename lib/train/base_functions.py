...
from lib.train.dataset import LasHeR, VTUAV
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full",
                        ...
                        "REFCOCOG", "TNL2K_train", "OTB99_train", "VTUAV_train"]
        # Tracking Task
        if name == "TNL2k":
...
def get_optimizer_scheduler(net, cfg, settings):
    ...
    #     # elif ("temporal_token_RGB_patch_pos_embed" in n):
    #     #     p.requires_grad = True
    #     elif ("fusion_layers" in n):
    #         p.requires_grad = True
    #     else:
