...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--save_name', type=str, default='odtrack_vl-'+str(num), help='Name of save file.')
...
def set_state(state, tracker_param):
    # path = './experiments/odtrack/'+tracker_param+'.yaml'
    path = "/home/local_data/lxh/code/ODVL/experiments/odtrack/baseline_256_full.yaml"
...
if __name__ == '__main__':
    cfg = 'baseline_256_full'
    datasets = ['lasot']#,'tnl2k',lasot_extension_subset]
    for i in range(45,50):
        savename = 'odvl_256_full_ep'+str(i)
