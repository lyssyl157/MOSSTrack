...
class MoSSTrackActor(BaseActor):
    ...
    def forward_pass(self, data):
        ...
        out_dict = self.net(template_list=template_list,
                            ...
                            pred_boxes=data['search_anno'].squeeze(0))
    ...
    def compute_losses(self, pred_dict, gt_dict, return_status=True):
        ...
        gt_gaussian_maps = generate_heatmap(gts, self.cfg.DATA.SEARCH.SIZE,
                                            self.cfg.MODEL.BACKBONE.STRIDE)  # list of torch.Size([b, H, W])
